...
export const Payments = () => {
  ...
  const { data: new_address } = useGetAccountData({
    api: `/customers/billing-address/new`,
    method: "get",
  });
  ...
  return (
    <>
      ...
      <SectionBody>
        ...
        />
        {billing_addresses && billing_addresses?.pagination && (
          <ApiPagination pagination={billing_addresses.pagination} />
        )}
      </SectionBody>
      <Modal
        data={data}
