  ...
  return (
    <div className="sectionPaddingX marginBottomSection" data-aos="fade-up">
      <div className="relative flex min-h-[750px] w-full flex-col items-center items-stretch gap-12 overflow-hidden rounded-[24px] lg:gap-8 lg:rounded-[30px] 2xl:flex-row 2xl:rounded-[50px]">
        {/* Banner content (left) */}
        <div className="flex w-full flex-col items-start justify-start gap-6 px-8 pt-10 text-white lg:w-1/2 lg:gap-[60px] lg:pt-[90px] xl:pl-20 2xl:w-1/3">
        ...
        {/* Product cards (right) */}
        <div className="relative z-10 grid w-fit grid-cols-1 items-center justify-center gap-6 pb-10 max-xl:mx-auto max-xl:px-8 md:mt-0 md:grid-cols-2 lg:w-fit lg:grid-cols-4 lg:justify-end xl:ml-auto xl:items-end xl:pr-14 2xl:w-fit">
          {products.map((product) => (
            ...
            >
              <div className="flexh-[260px] w-[260px] w-full min-w-[260px] items-center justify-center overflow-hidden rounded-[24px] bg-white lg:h-[200px] lg:w-[200px] lg:min-w-[200px] 4xl:h-[260px] 4xl:w-[260px] 4xl:min-w-[260px]">
                <Image
                  src={product.image[0] || "/images/placeholder.jpg"}
                  alt={product?.basic_data?.name}
                  width={260}
                  height={260}
                  className="h-[260px] w-[260px] object-contain transition-all duration-300 hover:scale-105 lg:h-[200px] lg:w-[200px] 4xl:h-[260px] 4xl:w-[260px]"
                />
              </div>
              <div className="flex flex-col gap-1">
                <div className="truncate text-[19px] text-white">
