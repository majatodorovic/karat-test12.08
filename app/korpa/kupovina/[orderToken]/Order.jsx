    ...
    <>
      ...
      <div className={`mt-20 grid grid-cols-2 gap-16 xl:grid-cols-3`}>
            ...
            {items?.map(
              ({
                ...
                return (
                  <div
                    key={id}
                    className={`col-span-1 overflow-hidden rounded-xl border`}
                  >
                    <Link href={`/${slug}`}>
                      <Image
        ...
        <div className={`col-span-2 xl:col-span-1`}>
          ...
          <div
            className={`mt-10 flex flex-col gap-2 rounded-xl bg-lightGray p-4`}
          >
          ...
          <div
            className={`mt-5 flex flex-col gap-2 rounded-xl bg-lightGray p-4`}
          >
            <h3 className={`${className} text-base font-light`}>
              Prodavac:{" "}
