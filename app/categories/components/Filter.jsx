        ...
        <div key={item.id}>
          <div className="mt-2 flex flex-row items-center gap-2 pl-4">
            <label
              ...
              className="flex h-[18px] w-[18px] cursor-pointer items-center justify-center rounded-md bg-white text-white max-xl:border"
            >
              <input
                type="checkbox"
                ...
                id={"chbx-" + item.id}
              />
              <div className="hidden h-3 w-3 rounded-full bg-primary peer-checked:block"></div>
            </label>
            <label
              htmlFor={"chbx-" + item.id}
