  ...
  return (
    <div className={`col-span-full mb-3 ${className ? className : ""}`}>
      <div className="flex items-center">
        <label
          htmlFor={name}
          className={`mr-2 block text-base font-light 2xl:text-[20px]`}
        >
          Rating
          {required && (
            <span
              className={`text-base font-light text-red-500 2xl:text-[20px]`}
            >
              {" "}
              *
            </span>
...
export const TextInput = ({
  ...
  return (
    <div className={`mb-3 ${className ? className : ""}`}>
      <label htmlFor={name} className={`text-base font-light 2xl:text-[20px]`}>
        {label}:
        {required && (
          <span className={`text-base font-light text-red-500 2xl:text-[20px]`}>
            {" "}
            *
          </span>
        )}
...
export const TextareaInput = ({
  ...
  return (
    <div className={`col-span-full mb-3 ${className ? className : ""}`}>
      <label
        htmlFor={name}
        className={`block text-base font-light 2xl:text-[20px]`}
      >
